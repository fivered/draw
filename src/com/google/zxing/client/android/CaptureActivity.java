...
//	private static final String PACKAGE_NAME = "com.google.zxing.client.android";
	...
	public static final String DISPLAY_BITMAP = "display_bitmap";
            ...
            cameraManager.getCamera().takePicture(null, null, new PictureCallback() {
                public void onPictureTaken(byte[] data, Camera camera) {
                    ...
                    try {
                    	...
                    	bitmap.recycle();
//                        data2file(data, path);// 存到SD卡
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
//                    Bitmap bitmap = BitmapFactory.decodeByteArray(data, 0, data.length);
                    backIntent.setData(Uri.fromFile(new File(path)));
                    backIntent.putExtras(intent.getExtras());
                    backIntent.putExtra("scan_result", result);
...
////            Bitmap bitmap = BitmapFactory.decodeByteArray(data, 0, data.length);
//            backIntent.setData(Uri.fromFile(new File(path)));
//            ArrayList<String> uris = backIntent.getStringArrayListExtra("Uris");
//            if(uris==null){
//            	uris=new ArrayList<String>();
//            }
//        	uris.add(path);
//        	backIntent.putExtra("Uris", uris);
//            if (index <= max)
//            {
//            	index++;
//            	camera.stopPreview();
